...
const Reference = () => {
  const [activeTab, setActiveTab] = useState<'income' | 'expense' | 'payment'>('income')
  ...
  }, [searchQuery, activeTab, allIncomeItems, allExpenseItems, allPaymentPlaces])
  ...
  const currentItems = activeTab === 'income' ? incomeItems : activeTab === 'expense' ? expenseItems : paymentPlaces
  const title = activeTab === 'income' ? 'Статьи доходов' : activeTab === 'expense' ? 'Статьи расходов' : 'Места оплаты'
